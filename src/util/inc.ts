...
import { Tail, Tail2, Tail4, Tail8 } from './shift';
...
type Inc<V extends number> = Add1[V];
type Inc2<V extends number> = Add2[V];
type Inc4<V extends number> = Add4[V];
type Inc8<V extends number> = Add8[V];
type Inc16<V extends number> = Add16[V];
// type Inc32<V extends number> = Add32[V];
// type Inc64<V extends number> = Add64[V];
// type Inc128<V extends number> = Add128[V];
